...
public class PSSLessThanExpression extends PSSExpression {

	PSSExpression	m_left;
	PSSExpression	m_right;

	public PSSLessThanExpression(PSSExpression left, PSSExpression right) {
		m_left = left;
		m_right = right;
	}
	...
	public PSSDomainMap deduceDomain(PSSInst var) {
		...
		if (leftInst != null) {
			...
			left_domain = left_domain.reduceDomainLessThan(rightVal);
