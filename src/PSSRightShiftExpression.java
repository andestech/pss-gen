...
public class PSSRightShiftExpression extends PSSExpression {

	PSSExpression	m_left;
	PSSExpression	m_right;

	public PSSRightShiftExpression(PSSExpression left, PSSExpression right) {
		m_left = left;
		m_right = right;
	}
	...
	public PSSVal eval(PSSInst var) {
		...
		return leftVal.RightShift(rightVal);
	}
